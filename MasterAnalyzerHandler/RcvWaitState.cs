    ...
    [System.Runtime.Versioning.SupportedOSPlatform("windows")]
     class RcvWaitState : ILISState
     {
          ...
          public void RcvACK()
          {
               ...
               ServiceMain.AppendToLog("ACK received in RcvWait state.");
          }
          ...
          public void RcvData(string InputString)
          {
               ...
               {
                    ServiceMain.AppendToLog("Frame number is incorrect!");
                    isFrameGood = false;
               }
               // Check checksum.
               if (isFrameGood)
          ...
          private bool CheckChecksum(string InputString)
          {
               ...
               if (checkSum != ServiceMain.CHKSum(mainMessage))
               {
                    return false;
               }
               // Otherwise, it's good.
          ...
          public void RcvENQ()
          {
               ...
               ServiceMain.AppendToLog("ENQ received in RcvWait state.");
          }
          ...
          public void RcvNAK()
          {
               ...
               ServiceMain.AppendToLog("NAK received in RcvWait state.");
          }

          void ILISState.HaveData()
          {
               // It doesn't matter if we have data to send. We're receiving right now.
               ServiceMain.AppendToLog("HaveData called in RcvWait state.");
          }
     }
}
